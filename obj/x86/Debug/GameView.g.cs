            ...
            IGameView_Bindings
        {
            ...
            private void Update_CurrentGame_CMan(global::BallDrive.Data.Characters.CharacterManager obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_CurrentGame_CMan_CurrentCharacter(obj.CurrentCharacter, phase);
                        this.Update_CurrentGame_CMan_Characters(obj.Characters, phase);
                    }
                }
            }
            private void Update_CurrentGame_CMan_CurrentCharacter(global::BallDrive.Data.Characters.StoryCharacter obj, int phase)
            {
